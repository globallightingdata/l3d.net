...
using GeometryDefinitionDto = L3D.Net.XML.V0_9_0.Dto.GeometryDefinitionDto;
...
using ShapeDto = L3D.Net.XML.V0_9_0.Dto.ShapeDto;
...
namespace L3D.Net.XML.V0_9_0
{
    internal class XmlDtoConverter : IXmlDtoConverter
    {
        ...
        internal AssignmentBaseDto Convert(LightEmittingFaceAssignment assignment)
        {
            if (assignment == null)
                return null;
            ...
            if (assignment is SingleLightEmittingFaceAssignment single)
            {
                ...
                {
                    LightEmittingPartName = single.PartName,
            ...
            {
                return new RangeAssignmentDto
                {
                    LightEmittingPartName = range.PartName,
