...
namespace L3D.Net.Tests.Mapper.V0_10_0
{
    ...
    public class LuminaireMapperTests : MapperTestBase
    {
        private static IEnumerable<TestCaseData> TestCases()
        {
            ...
            yield return new TestCaseData(
                    new LuminaireDto { Header = new HeaderDto { Name = "name1", Description = "desc", CreatedWithApplication = "app", CreationTimeCode = utcNow } },
                    new Luminaire { Header = new Header { Name = "name1", Description = "desc", CreatedWithApplication = "app", CreationTimeCode = utcNow } })
                .SetArgDisplayNames(nameof(LuminaireDto.Header), nameof(Luminaire.Header));
            yield return new TestCaseData(
                    new LuminaireDto { GeometryDefinitions = new List<GeometryDefinitionDto> { new GeometryFileDefinitionDto { GeometryId = "id" } } },
                    new Luminaire { GeometryDefinitions = new List<GeometryFileDefinition> { new() { GeometryId = "id" } } })
            ...
            yield return new TestCaseData(
                    new LuminaireDto
                    {
                        ...
                        Header = new HeaderDto { Name = "name1", Description = "desc", CreatedWithApplication = "app", CreationTimeCode = utcNow },
                    ...
                    new Luminaire
                    {
                        ...
                        Header = new Header { Name = "name1", Description = "desc", CreatedWithApplication = "app", CreationTimeCode = utcNow },
